// ignore_for_file: prefer_const_constructors, library_private_types_in_public_api, import_of_legacy_library_into_null_safe, use_key_in_widget_constructors, camel_case_types, sized_box_for_whitespace
import 'package:flutter/material.dart';
import 'package:foldable_sidebar/foldable_sidebar.dart';
import 'package:page_transition/page_transition.dart';
import 'package:pro_tekno1/Services/BlogServices/BlogService.dart';
              ...
              itemBuilder: (BuildContext context, int index) {
                return ElevatedButton(
                  ...
                  child: Column(
                    ...
                    children:[
                    Link(
                      url: snapshot.data!.data![index].instagramUrl.toString(),
                      child: Container(
