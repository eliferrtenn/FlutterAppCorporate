// ignore_for_file: prefer_const_constructors, library_private_types_in_public_api, import_of_legacy_library_into_null_safe, use_key_in_widget_constructors, camel_case_types, non_constant_identifier_names, file_names
...
import '../models/responseModels/humanResourceResponses/GetHumanResourceResponse.dart';

class HumanResourcePage extends StatefulWidget {
  @override
  _HumanResourcePageState createState() => _HumanResourcePageState();
}
  ...
  Container SectionDescription() {
    return Container(
          ...
          child: Column(
            children: [
              FutureBuilder(
              future: CommonService.getHumanResource(),
              builder: (context, AsyncSnapshot<GetHumanResourceResponse> snapshot) {
                  if (snapshot.hasData) {
                    return Column(
                      children: [
                        Text(
    ...
    return Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/images/corporate/CorporateHumanResource.jpg'),
                      fit: BoxFit.fill,
                    ),
                    borderRadius: BorderRadius.all(Radius.circular(35))));
  }

  FutureBuilder<GetHumanResourceResponse> SectionTitle() {
