...
import 'package:pro_tekno1/corporate/generalCorporatePagePartial.dart';
import '../constants/generalDrawer.dart';
import '../projects/generalProjectPage.dart';
import '../media/homeMedia.dart';
class GeneralCorporatePage extends StatefulWidget {
  const GeneralCorporatePage({super.key});

  @override
  State<GeneralCorporatePage> createState() => _GeneralCorporatePageState();
}

class _GeneralCorporatePageState extends State<GeneralCorporatePage> {
