...
import '../models/RequestModels/TechnicalServiceDemandRequests/CreateTechnicalServiceDemandRequest.dart';
...
class CreateTechnicalServiceDemandPage extends StatefulWidget {
  const CreateTechnicalServiceDemandPage({super.key});

  @override
  State<CreateTechnicalServiceDemandPage> createState() =>
      _CreateTechnicalServiceDemandPageState();
}

class _CreateTechnicalServiceDemandPageState
    extends State<CreateTechnicalServiceDemandPage> {
  ...
  void loginVerifySubmit() async {
    CreateTechnicalServiceDemandRequest? request =
    ...
    var loginResponse = TechnicServiceDemandService.CreateTechnicalServiceDemand(request);
