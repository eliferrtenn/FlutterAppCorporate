...
class GetTechnicalServiceDemandResponse {
  Data? data;
  bool? isSuccess;
  String? message;

  GetTechnicalServiceDemandResponse({this.data, this.isSuccess, this.message});

  GetTechnicalServiceDemandResponse.fromJson(Map<String, dynamic> json) {
